...
int main()
{
	...
	myFile << endl;
	myFile << "CULTURE AND SENSITIVITY PRICES:" << endl;
	...
	myFile << "Aerobic culture, Anaerobic culture, sensitivity: $" << aerobic + 
		anaerobic + sensitivity << endl;
	myFile << "Aerobic culture and sensitivity: $" << aerobic + sensitivity
		<< endl;
